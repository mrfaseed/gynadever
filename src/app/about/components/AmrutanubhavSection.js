        ...
        <section className={`${styles.section} ${styles.separatorSection}`} ref={addToRefs}>
            <div className={`${styles.dedicationText} ${styles.transparentCard}`}>
                ...
                <div className={styles.downloadSection}>
                    <a href="/Page%20No.%201-%20320%20PLATE.pdf" className={styles.downloadBtn} download="Amrutanubhavam.pdf" target="_blank" rel="noopener noreferrer">Download Amrutanubhav Tamil</a>
